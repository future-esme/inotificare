      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            bodyRo: expect.any(Object),
            bodyRu: expect.any(Object),
            bodyEn: expect.any(Object),
            bodyShortRo: expect.any(Object),
            bodyShortRu: expect.any(Object),
            bodyShortEn: expect.any(Object),
            subjectRo: expect.any(Object),
            subjectRu: expect.any(Object),
            subjectEn: expect.any(Object),
          }),
        );
      });
