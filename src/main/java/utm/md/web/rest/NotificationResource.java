...
import utm.md.service.NotificationQueryService;
import utm.md.service.NotificationService;
import utm.md.service.criteria.NotificationCriteria;
import utm.md.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link utm.md.domain.Notification}.
 */
@RestController
...
public class NotificationResource {
     ...
     */
    @GetMapping("/{id}")
    public ResponseEntity<Notification> getNotification(@PathVariable("id") UUID id) {
